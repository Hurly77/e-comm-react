...
export default function CheckoutDrawer() {
  ...
  const { checkoutDrawerStates, selectedPm, selectedAddress } = checkoutCtx;
  ...
  async function handleOnCompleteOrder() {
    ...
    if (!user_id || !pm_id) return console.error("User ID or Payment Method ID is missing");
  ...
  return (
    <Drawer title="Confirm Order" onClose={() => setIsOpen(false)} isOpen={isOpen}>
      ...
      <div className="w-full">
        <Button onPress={handleOnCompleteOrder} size="lg" radius="sm" className="w-full" color="success">
